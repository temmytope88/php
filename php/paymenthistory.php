...
<div class="nav"> 
 ...
 <div class="container"> 
   ...
   <?php 
            $file = Scandir("db/payments_initiated");
            $number = count($file);
            //print($number);
            $actualnum = $number - 2;
           // print($actualnum);     
                  ...
                  //  print($userfiles);
                   ...
                   // print($userobject);
                    if($userfiles != "." && $userfiles != ".."){
                      $userobject = file_get_contents("db/payments_initiated/".$userfiles);
                      //print($userobject);
                      $userdetails = json_decode($userobject, TRUE);
                      
                      if($userdetails["email"] == $_SESSION["email"]){
                       // print_r($userdetails);
