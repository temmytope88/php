                ...
                //send the reset password to user email to confirm he has access to the mail    
                           ...
                           $alpha =["a","s","d","f","g","h","j","k","l","m","n","b","v","c","x","z","q","w","e","r","t",  "y","A","S","D","F","G","H","J","K","L","U","I","O","P","Z","X","C","V","B","N"];
                            ...
                            // print_r($token);
                             ...
                             $message = "A password change was authorized for this mail, kindly ignore if u did not authorize it. Otherwise, click on the link localhost/SNH-V2/php/pwreset.php?token=".$token;
